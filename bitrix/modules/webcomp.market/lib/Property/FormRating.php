...
class FormRating {
    ...
    static function OnIBlockPropertyBuildList() {
      ...
      if(!isset($_REQUEST["propedit"]) && $_REQUEST["type"] !== self::IBLOCK_TYPE)
        ...
        return [
  	      ...
  	      "DESCRIPTION"           => Loc::getMessage('PROPERTY_RATING_NAME'),
    ...
    * @return mixed
    */
    static function ConvertToDB($arProp, $value) {
      # modification value before saving to the database
        ...
        if($value > $prop["PROPERTY_MAX_VALUE"])
            $value = intval($prop["PROPERTY_MAX_VALUE"]);
    ...
    */
    static function GetPropertyFieldHtml($arProp, $value, $control) {
        ...
        $html = '<input type="text" name="'.$control["VALUE"].'" size="30" value="'.$value["VALUE"].'"> '.Loc::getMessage("PROPERTY_RATING_MAX_VALUE_TEXT").' - '.$prop["PROPERTY_MAX_VALUE"];
        return  $html;
    }
    ...
    */
    ...
    static function PrepareSettings($arFields) {
      ...
      if(empty($arFields["USER_TYPE_SETTINGS"]["PROPERTY_MSG_ERROR_VALIDATE"])) {
        $arFields["USER_TYPE_SETTINGS"]["PROPERTY_MSG_ERROR_VALIDATE"] = Loc::getMessage("PROPERTY_RATING_MSG_ERROR_VALIDATE_DEFAULT");
      }
    ...
    static function GetSettingsHTML($arProp, $control, &$arPropertyFields) {
      ...
      $arPropertyFields = [
	      'HIDE' => [
	    	...
	    	'SET' => [],
	    	'SHOW' => [],
	    	'USER_TYPE_SETTINGS_TITLE' => Loc::getMessage("PROPERTY_RATING_CUSTOM_BLOCK")
      ];
    	...
    	<tr>
				<td width="40%" class="adm-detail-content-cell-l">
					<label for="PROPERTY_RATING_MSG_ERROR_VALIDATE"><?=Loc::getMessage("PROPERTY_RATING_MSG_ERROR_VALIDATE")?></label>
				</td>
				<td class="adm-detail-content-cell-r">
					<input  id="PROPERTY_RATING_MSG_ERROR_VALIDATE"
                  size="50" 
                  type="text" 
      ...
      <tr>
        <td width="40%" class="adm-detail-content-cell-l">
          <label for="PROPERTY_RATING_DISABLED_FIELD"><?=Loc::getMessage("PROPERTY_RATING_DISABLED_FIELD")?></label>
        </td>
        <td class="adm-detail-content-cell-r">
          <input id="PROPERTY_RATING_DISABLED_FIELD"
                type="checkbox" 
                value="Y" 
      ...
      <tr>
        <td width="40%" class="adm-detail-content-cell-l">
          <label for="PROPERTY_RATING_HIDDEN_FIELD"><?=Loc::getMessage("PROPERTY_RATING_HIDDEN_FIELD")?></label>
        </td>
        <td class="adm-detail-content-cell-r">
          <input id="PROPERTY_RATING_HIDDEN_FIELD"
                type="checkbox" 
                value="Y" 
        ...
        <tr>
            <td width="40%" class="adm-detail-content-cell-l">
                <label for="PROPERTY_RATING_MSG_ERROR_VALIDATE"><?=Loc::getMessage("PROPERTY_RATING_MAX_VALUE")?></label>
            </td>
            <td class="adm-detail-content-cell-r">
                <input  id="PROPERTY_RATING_MSG_ERROR_VALIDATE"
                        size="50"
                        type="text"
                        value="<?=$prop["PROPERTY_MAX_VALUE"]?>"
                        name="<?=$control["NAME"]?>[PROPERTY_MAX_VALUE]"
                >
            </td>
        </tr>
