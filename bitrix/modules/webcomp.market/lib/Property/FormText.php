...
class FormText {
    ...
    static function OnIBlockPropertyBuildList() {
      ...
      if(!isset($_REQUEST["propedit"]) && $_REQUEST["type"] !== self::IBLOCK_TYPE)
        ...
        return [
  	      ...
  	      "DESCRIPTION"           => Loc::getMessage('PROPERTY_TEXT_NAME'),
    ...
    */
    static function GetPropertyFieldHtml($arProp, $value, $control) {
        ...
        $html = '<textarea style="width:100%;height:100px;" class="textarea" name="'.$control["VALUE"].'">'.$value["VALUE"].'</textarea>';
        return  $html;
    }
    ...
    */
    ...
    static function PrepareSettings($arFields) {
      ...
      if(empty($arFields["USER_TYPE_SETTINGS"]["PROPERTY_MSG_ERROR_VALIDATE"])) {
        $arFields["USER_TYPE_SETTINGS"]["PROPERTY_MSG_ERROR_VALIDATE"] = Loc::getMessage("PROPERTY_TEXT_MSG_ERROR_VALIDATE_DEFAULT");
      }
    ...
    static function GetSettingsHTML($arProp, $control, &$arPropertyFields) {
      ...
      $arPropertyFields = [
	      'HIDE' => [
	    	...
	    	'SET' => [],
	    	'SHOW' => [],
	    	'USER_TYPE_SETTINGS_TITLE' => Loc::getMessage("PROPERTY_TEXT_CUSTOM_BLOCK")
      ];
    	...
    	<tr>
				<td width="40%" class="adm-detail-content-cell-l">
					<label for="PROPERTY_TEXT_MSG_ERROR_VALIDATE"><?=Loc::getMessage("PROPERTY_TEXT_MSG_ERROR_VALIDATE")?></label>
				</td>
				<td class="adm-detail-content-cell-r">
					<input  id="PROPERTY_TEXT_MSG_ERROR_VALIDATE"
                  size="50" 
                  type="text" 
      ...
      <tr>
        <td width="40%" class="adm-detail-content-cell-l">
          <label for="PROPERTY_TEXT_DISABLED_FIELD"><?=Loc::getMessage("PROPERTY_TEXT_DISABLED_FIELD")?></label>
        </td>
        <td class="adm-detail-content-cell-r">
          <input id="PROPERTY_TEXT_DISABLED_FIELD"
                type="checkbox" 
                value="Y" 
      ...
      <tr>
        <td width="40%" class="adm-detail-content-cell-l">
          <label for="PROPERTY_TEXT_HIDDEN_FIELD"><?=Loc::getMessage("PROPERTY_TEXT_HIDDEN_FIELD")?></label>
        </td>
        <td class="adm-detail-content-cell-r">
          <input id="PROPERTY_TEXT_HIDDEN_FIELD"
                type="checkbox" 
                value="Y" 
