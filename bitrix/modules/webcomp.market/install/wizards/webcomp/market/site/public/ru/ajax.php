                    ...
                    <div class="cart__btns">
                        <div class="cart__btn">
                            <button class="cart__one btn3 cart__btn-btn"
                                    type="button"
                                    data-event="showForm"
                                    data-request="#WIZARD_SITE_DIR#ajax/cart/"
                    ...
                    <div class="cart__btns">
                        <div class="cart__btn">
                            <a class="cart__buy btn cart__btn-btn"
                               href="#WIZARD_SITE_DIR#cart/favorite/">
...
function getReviewForm()
{
    ...
    <div class="popup__middle">
        <form class="popup__form" action="#WIZARD_SITE_DIR#ajax.php"
              method="post"
                ...
                <div class="popup__field popup__field_m30">
                    ...
                    <label class="file">
                        <input class="file__input" type="file" name="userPhoto"><span
                                class="file__fake">
                      <svg class="file__svg">
                        <use xlink:href="#WIZARD_SITE_DIR#images/icons/sprite.svg#staple"></use>
    ...
    <div class="popup__middle">
        <div class="city">
            <div class="city__field">
                ...
                <svg class="city__svg">
                    <use xlink:href="#WIZARD_SITE_DIR#images/icons/sprite.svg#magnifier"></use>
                </svg>
            </div>
