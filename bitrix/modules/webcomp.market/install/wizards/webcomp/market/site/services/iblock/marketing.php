...
foreach ($iblocks as $iblock) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID
        ."/marketing/webcomp_market_$iblock.xml";
    $iblockType = "marketing";
    $iblockCode = "webcomp_market_{$iblockType}_$iblock";
    $iblockApiCode = snakeToCamel($iblockCode);

    $absoluteIblockXMLFile = WIZARD_SERVICE_ABSOLUTE_PATH."/xml/".LANGUAGE_ID
        ."/marketing/webcomp_market_$iblock.xml";
    CWizardUtil::ReplaceMacros($absoluteIblockXMLFile,
