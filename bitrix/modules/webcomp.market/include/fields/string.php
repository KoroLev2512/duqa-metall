...
<div class="webcomp-settings__field webcomp-settings__field--string <?=$arOption["CLASS"]?>">
    <div class="webcomp-settings__field-title"><?=$arOption["TITLE"]?></div>
    <div class="webcomp-settings__field-wrap">
        <input type="text" class="webcomp-settings__field-input <?=$arOption["INPUT_CLASS"]?>"
