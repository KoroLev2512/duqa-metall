	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
        <div class="search-page__item">
            ...
            <? if($arItem["PICTURE"]["src"]): ?>
                <div class="search-page__picture-block">
                    <a class="search-page__image-link" href="<?=$arItem["URL"]?>">
                        <img class="search-page__image" src="<?=$arItem["PICTURE"]["src"]?>" alt="<?=$arItem["TITLE"]?>">
                    </a>
                </div>
            <? endif ?>

            <div class="search-page__content-block">
                <a class="search-page__title" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
                <p class="search-page__txt"><?echo $arItem["BODY_FORMATED"]?></p>
                <?if (
                ...
                <? if($arItem["CHAIN_PATH"]):?>
                    <div class="search-page__path"><?=$arItem["CHAIN_PATH"]?></div>
                <? endif; ?>
            </div>
        </div><hr />
	<?endforeach;?>
