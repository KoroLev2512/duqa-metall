...
<p><a href="<?= $arResult["FOLDER"]
    .$arResult["URL_TEMPLATES"]["news"] ?>"><?= GetMessage("T_NEWS_DETAIL_BACK") ?></a>
</p>
...
<? if ($arParams["USE_CATEGORIES"] == "Y" && $ElementID):
    ...
    if (count($arCategoryFilter) > 0):
        $arCategoryFilter = [
            "PROPERTY_"
            .$arParams["CATEGORY_CODE"] => array_keys($arCategoryFilter),
            "!"."ID"                    => $ElementID,
        ];
        ?>
