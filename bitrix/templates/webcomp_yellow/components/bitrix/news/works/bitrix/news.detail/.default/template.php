...
<div class="service__top">
    ...
    <? if (!empty($arResult["DETAIL_PICTURE"]["SRC"])): ?>
        <div class="service__img">
            <img class="service__img-img" src="<?= $arResult["DETAIL_PICTURE"]["SRC"] ?>"
                 alt="<?= $arResult["NAME"] ?>">
        </div>
    <? endif ?>
...
<div class="service__banner">
    <div class="sbanner">
        ...
        <div class="sbanner__right">
            ...
            <button data-id="<?= $arResult["ID"] ?>" class="btn sbanner__btn" data-trigger="click" data-target="CALLORDER"
...
<? if (!empty($arResult["PROPERTIES"]["GALLERY"]["VALUE"])) : ?>
    <div class="service__gallery">
        ...
        <div class="product__gallery pgallery">
            <button class="pgallery__prev pgallery__arr swiper-button-disabled" type="button" tabindex="0" role="button"
                    ...
                    <? foreach ($arResult["PROPERTIES"]["GALLERY"]["VALUE"] as $key => $image): ?>
                        <div class="swiper-slide pgallery__item">
                            <div class="pgallery__img">
                                <img class="pgallery__img-img" src="<?= CFile::getPath($image) ?>"
            ...
            <button class="pgallery__next pgallery__arr" type="button" tabindex="0" role="button"
...
<? if (!empty($arResult['PROPERTIES']['PRODUCTS']['VALUE'])): ?>
    ...
    $recommendProductFilter = ['ID' => $arResult['PROPERTIES']['PRODUCTS']['VALUE']];
