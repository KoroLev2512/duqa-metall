            ...
            <div class="main-ui-pagination-pages-list">
                ...
                if ($arResult["CURRENT_PAGE"] < $arResult["PAGE_COUNT"]):
                    if ($arResult["START_PAGE"] < $arResult["PAGE_COUNT"]):
                        ...
                        <a data-slider-ignore-autobinding="true"
                           class="main-ui-pagination-page"
                           href="<?= htmlspecialcharsbx($arResult["URL"]) ?>">1</a>
                        <?
                        if ($arResult["START_PAGE"] < ($arResult["PAGE_COUNT"]
                                - 1)
                        ):
                            ?>
                            <a data-slider-ignore-autobinding="true"
                               class="main-ui-pagination-page main-ui-pagination-dots"
                               href="<?= htmlspecialcharsbx($component->replaceUrlTemplate($arResult["START_PAGE"]
                                   + ($arResult["PAGE_COUNT"]
                                       - $arResult["START_PAGE"])
                                   / 2)) ?>">...</a>
                        <?
                ...
                do {
                    ...
                    elseif ($page == $arResult["PAGE_COUNT"]):
                        ...
                        <a data-slider-ignore-autobinding="true"
                           class="main-ui-pagination-page"
                           href="<?= htmlspecialcharsbx($arResult["URL"]) ?>"><?= $pageNumber ?></a>
                    <?
                    else:
                        ?>
                        <a data-slider-ignore-autobinding="true"
                           class="main-ui-pagination-page"
                           href="<?= htmlspecialcharsbx($component->replaceUrlTemplate($page)) ?>"><?= $pageNumber ?></a>
                    <?
                    endif;
                ...
                if ($arResult["CURRENT_PAGE"] > 1):
                    if ($arResult["END_PAGE"] > 1):
                        if ($arResult["END_PAGE"] > 2):
                            ...
                            <a data-slider-ignore-autobinding="true"
                               class="main-ui-pagination-page main-ui-pagination-dots"
                               href="<?= htmlspecialcharsbx($component->replaceUrlTemplate(round($arResult["END_PAGE"]
                                   / 2))) ?>">...</a>
                        <?
                        endif;
                        ?>
        ...
        <div class="main-ui-pagination-arrows">
            ...
            if ($arResult["CURRENT_PAGE"] < $arResult["PAGE_COUNT"]):
                if (($arResult["CURRENT_PAGE"] + 1) == $arResult["PAGE_COUNT"]):
                    ?>
                    <a data-slider-ignore-autobinding="true"
                       class="main-ui-pagination-arrow main-ui-pagination-prev"
                       href="<?= htmlspecialcharsbx($arResult["URL"]) ?>"><?= GetMessage("grid_nav_prev") ?></a>
                <?
                else:
                    ?>
                    <a data-slider-ignore-autobinding="true"
                       class="main-ui-pagination-arrow main-ui-pagination-prev"
                       href="<?= htmlspecialcharsbx($component->replaceUrlTemplate($arResult["CURRENT_PAGE"]
                           + 1)) ?>"><?= GetMessage("grid_nav_prev") ?></a>
                <?
                endif;
            else:
                ?>
            ...
            if ($arResult["SHOW_ALL"]):
                if ($arResult["ALL_RECORDS"]):
                    ?>
                    <a data-slider-ignore-autobinding="true"
                       class="main-ui-pagination-arrow"
                       href="<?= htmlspecialcharsbx($arResult["URL"]) ?>"><?= GetMessage("grid_nav_paged") ?></a>
                <?
                else:
                    ?>
                    <a data-slider-ignore-autobinding="true"
                       class="main-ui-pagination-arrow"
                       href="<?= htmlspecialcharsbx($component->replaceUrlTemplate("all")) ?>"><?= GetMessage("grid_nav_all") ?></a>
                <?
                endif;
            endif;
            ...
            if ($arResult["CURRENT_PAGE"] > 1):
                ?>
                <a data-slider-ignore-autobinding="true"
                   class="main-ui-pagination-arrow main-ui-pagination-next"
                   href="<?= htmlspecialcharsbx($component->replaceUrlTemplate($arResult["CURRENT_PAGE"]
                       - 1)) ?>"><?= GetMessage("grid_nav_next") ?></a>
            <?
            else:
                ?>
            ...
            <div class="main-ui-pagination-pages-list">
                ...
                if ($arResult["CURRENT_PAGE"] > 1):
                    if ($arResult["START_PAGE"] > 1):
                        ...
                        if ($arResult["START_PAGE"] > 2):
                            ...
                            <a data-slider-ignore-autobinding="true"
                               class="main-ui-pagination-page main-ui-pagination-dots"
                               href="<?= htmlspecialcharsbx($component->replaceUrlTemplate(round($arResult["START_PAGE"]
                                   / 2))) ?>">...</a>
                        <?
                        endif;
                    endif;
                ...
                do {
                    ...
                    <?
                        ...
                        <a data-slider-ignore-autobinding="true"
                           class="main-ui-pagination-page"
                           href="<?= htmlspecialcharsbx($component->replaceUrlTemplate($page)) ?>"><?= $page ?></a>
                    <?
                    endif;
