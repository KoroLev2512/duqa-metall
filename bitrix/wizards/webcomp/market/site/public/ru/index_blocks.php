<main class="index">
    ...
    <section class="index__banner" data-order="-1">
    ...
    <? if (in_array("advantages", $sections)): ?>
        <section class="ibanner__advantages" data-order="<?= array_search("advantages", $sections) ?>">
            <?
            $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "advantages",
    ...
    <? if (in_array("services", $sections)): ?>
        <section class="index__services" data-order="<?= array_search("services", $sections) ?>">
            <?
    ...
    <? if (in_array("projects", $sections)): ?>
        <section class="index__projects" data-order="<?= array_search("projects", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "projects_on_main",
                [
    ...
    <? if (in_array("popular", $sections)): ?>
        <section class="index__popular" data-order="<?= array_search("popular", $sections) ?>">
    ...
    <? if (in_array("reccomended", $sections)): ?>
        <section class="index__reccomended" data-order="<?= array_search("reccomended", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
    ...
    <? if (in_array("promo", $sections)): ?>
        <section class="index__promo" data-order="<?= array_search("promo", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "banner_on_main",
                [
    ...
    <? if (in_array("categories", $sections)): ?>
        <section class="index__cats" data-order="<?= array_search("categories", $sections) ?>">
    ...
    <? if (in_array("actions", $sections)): ?>
        <section class="index__actions" data-order="<?= array_search("actions", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "actions_on_main",
                [
    ...
    <? if (in_array("news", $sections)): ?>
        <section class="index__news" data-order="<?= array_search("news", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "news_on_main",
                [
    ...
    <? if (in_array("about", $sections)): ?>
        <section class="index__about" data-order="<?= array_search("about", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "about_on_main",
                [
    ...
    <? if (in_array("reviews", $sections)): ?>
        <section class="index__revs" data-order="<?= array_search("reviews", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "revs_on_main",
                array(
    ...
    <? if (in_array("brands", $sections)): ?>
        <section class="index__brands" data-order="<?= array_search("brands", $sections) ?>">
            <? $APPLICATION->IncludeComponent(
                "webcomp:element.getList",
                "brands_on_main",
                array(
