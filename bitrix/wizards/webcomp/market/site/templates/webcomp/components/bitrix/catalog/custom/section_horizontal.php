...
<? if ($isFilter): ?>
    ...
    <div class="filters col-xs-12<?= (isset($arParams['FILTER_HIDE_ON_MOBILE'])
    && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '') ?>">
...
$sectionListParams = array(
    ...
    "CACHE_GROUPS" => $arParams["CACHE_GROUPS"],
				...
				$intSectionID = $APPLICATION->IncludeComponent(
					...
					"custom",
					array(
                        "VIEW_TYPE" => $_SESSION["VIEW_TYPE"] ?: "block",
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
						"ELEMENT_SORT_FIELD" => ($_SESSION["SORT"]["NAME"]) ?: $arParams["ELEMENT_SORT_FIELD"],
						"ELEMENT_SORT_ORDER" => ($_SESSION["SORT"]["ORDER"]) ?: $arParams["ELEMENT_SORT_ORDER"],
