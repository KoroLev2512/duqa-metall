...
if ( ! empty($arResult["ERROR_MESSAGE"])):
    $arResult["ERROR_MESSAGE"] = preg_replace([
        "/<br(.*?)><br(.*?)>/is",
        "/<br(.*?)>$/is",
    ], ["<br />", ""], $arResult["ERROR_MESSAGE"]);
    ?>
    <div class="reviews-note-box reviews-note-error">
        <div class="reviews-note-box-text"><?= ShowError($arResult["ERROR_MESSAGE"],
                "reviews-note-error"); ?></div>
    </div>
<?
endif;
?>
    <div class="reviews-reply-form" <?= (($arParams['SHOW_MINIMIZED'] == "Y")
        ? 'style="display:none;"' : '') ?>>
        ...
        ?> method="POST" enctype="multipart/form-data" class="reviews-form">
            ...
            <input type="hidden" name="index"
                   value="<?= htmlspecialcharsbx($arParams["form_index"]) ?>"/>
            <input type="hidden" name="back_page"
                   value="<?= $arResult["CURRENT_PAGE"] ?>"/>
            ...
            <input type="hidden" name="AJAX_POST"
                   value="<?= $arParams["AJAX_POST"] ?>"/>
            <?= bitrix_sessid_post() ?>
            <?
            ...
            <div style="position:relative; display: block; width:100%;">
                    ...
                    <div class="reviews-reply-fields">
                        <div class="reviews-reply-field-user">
                            <div class="reviews-reply-field reviews-reply-field-author">
                                <label for="REVIEW_AUTHOR<?= $arParams["form_index"] ?>"><?= GetMessage("OPINIONS_NAME") ?><?
                                    ?>
                ...
                <div class="reviews-reply-header">
                    <span><?= $arParams["MESSAGE_TITLE"] ?></span><span
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        [
                            ...
                            "TEXT" => [
                                "ID"     => "REVIEW_TEXT",
                                "NAME"   => "REVIEW_TEXT",
                                "VALUE"  => isset($arResult["REVIEW_TEXT"])
                    ...
                    <div class="reviews-reply-field reviews-reply-field-upload">
                        ...
                        if ( ! empty($arResult["REVIEW_FILES"])):
                            foreach ($arResult["REVIEW_FILES"] as $key => $val):
                                $iCount++;
                                $sFileSize
                                    = CFile::FormatSize(intval($val["FILE_SIZE"]));
                                ?>
                        ...
                        if ($iCount < $arParams["FILES_COUNT"]):
                            $sFileSize
                                = CFile::FormatSize(intVal(COption::GetOptionString("forum",
                            ...
                            <div class="reviews-upload-info"
                                ...
                                ?>
                                <span><?= str_replace("#SIZE#", $sFileSize,
                                        GetMessage("F_FILE_SIZE")) ?></span>
                            </div>
                            <?

                            for (
                                $ii = $iCount; $ii < $arParams["FILES_COUNT"];
                                $ii++
                            ):
                                ?>
                            ...
                            <a class="forum-upload-file-attach"
                               ...
                               onclick="AttachFile('<?= $iCount ?>', '<?= ($ii
                                ...
                                <span><?= ($arResult["FORUM"]["ALLOW_UPLOAD"]
                                        == "Y") ? GetMessage("F_LOAD_IMAGE")
                                        : GetMessage("F_LOAD_FILE") ?></span>
                            </a>
                        <?
                        endif;
                        ?>
                ...
                <div class="reviews-reply-buttons">
                    ...
                    <input name="view_button" type="submit"
