...
while ($ob = $res->GetNextElement()) {
    ...
    $arItem["REVIEWS"][$arFields["ID"]]["PREVIEW_TEXT"]
        = $arProps["MESSAGE"]["VALUE"]["TEXT"];
    $arItem["REVIEWS"][$arFields["ID"]]["DETAIL_TEXT"]
        = $arProps["MESSAGE"]["VALUE"]["TEXT"];
    $arItem["REVIEWS"][$arFields["ID"]]["PREVIEW_PICTURE"]
        = CFile::getPath($arProps["PHOTO"]["VALUE"]);
    $arItem["REVIEWS"][$arFields["ID"]]["DETAIL_PICTURE"]
        = CFile::getPath($arProps["PHOTO"]["VALUE"]);
    $arItem["REVIEWS"][$arFields["ID"]]["ACTIVE_FROM"]
...
?>
    ...
    <div class="service__wrap">
        <? if (!empty($arItem["PROPERTIES"]["SUB_TITLE"]["VALUE"])): ?>
        ...
        <div class="service__top">
            <? if (!empty(current($arItem["PHOTO"]))): ?>
                <div class="service__img">
                    <img class="service__img-img" src="<?= current($arItem["PHOTO"]); ?>"
                         alt="<?= $arItem["NAME"] ?>">
                </div>
            <? endif ?>
                ...
                <div class="sbanner__left">
                    <div class="sbanner__img">
                        <img class="sbanner__img-img"
                             ...
                             alt="Заказать услугу <?= $arItem["NAME"] ?>">
                    </div>
                    <div class="sbanner__txt"><?= GetMessage("BANNER_TEXT") ?></div>
                </div>
                <div class="sbanner__right">
                    <? if ( ! empty($arItem["PROPERTIES"]["OLD_PRICE"]["VALUE"])): ?>
                        <div class="sbanner__oldprice"><?= $arItem["PROPERTIES"]["OLD_PRICE"]["VALUE"] ?></div>
                    <? endif ?>

                    <? if ( ! empty($arItem["PROPERTIES"]["PRICE"]["VALUE"])): ?>
                        <div class="sbanner__price"><?= $arItem["PROPERTIES"]["PRICE"]["VALUE"] ?></div>
                    <? endif ?>
                ...
                <div class="product__gallery pgallery">
                    ...
                    <div class="swiper-container pgallery__container">
                        <div class="swiper-wrapper">
                            <? foreach ($arItem["GALLERY"] as $key => $image):
                                ?>
        ...
        <? if (!empty($arItem['PROPERTIES']['RECOMMENDED']['VALUE'])): ?>
            <?
            global $recommendProductFilter;
            $recommendProductFilter = ['ID' => $arItem['PROPERTIES']['RECOMMENDED']['VALUE']];
...
<? /*
    <div data-type="item" class="product__main" id="<?= $itemIds['ID'] ?>" itemscope itemtype="http://schema.org/Product">
        <div class="row">
            ...
            <div class="product__right">
                ...
                <div class="product__info">
                    <? if (!empty($arItem["ARTICLE"])): ?>
                        <div class="product__info-articul">Артикул: <?= $arItem["ARTICLE"] ?></div>
                    <? endif ?>
                ...
                <? if ($bCanBuy): ?>
                    <div class="product__btns">
                        <div class="product__add">
                            ...
                            <button class="add product__buy add_product"
                                type="button"
                                    ...
                                    <div class="pdoc">
                                        ...
                                        <div class="pdoc__right">
                                            ...
                                            <a class="pdoc__link" href="<?= $fileInfo["SRC"] ?>"
                                               download="<?= $fileInfo["ORIGINAL_NAME"] ?>">Скачать</a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="rev__left">
                                                <div class="rev__img">
                                                    <div class="rev__img-wrap">
                                                        <img class="rev__img-img" src="<?= $item["PREVIEW_PICTURE"] ?>"
                                                             alt="<?= $item["NAME"] ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <? if (!empty($item["MORE_PHOTO"]) || !empty($item["YOUTUBE"])): ?>
                                                    ...
                                                    <div class="rev__bottom">
                                                        <button class="rev__more" type="button"><span
                                                                    class="rev__more-open">Развернуть</span><span
                                                                    class="rev__more-close">Свернуть</span></button>
                                                    </div>
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id=""
